                                        ...
                                        <ul class="slides">
                                            @if(isset($item['images']) && is_array($item['images']) && count($item['images']) > 0)
                                                ...
                                                @foreach($item['images'] as $key => $img)
                                                    <li class="featured-image format-image">
...
@section('PAGE-LEVEL-PLUGINS')
    ...
    <script src="/admin/assets/global/plugins/woocommerce-flexslider/jquery.flexslider-min.js"></script>

    {{--<script type="text/javascript" src="http://wp1.imithemes.com/autostars-wp/wp-content/themes/AutoStars/vendor/magnific/jquery.magnific-popup.min.js?ver=0.1"></script>--}}
    {{--<script type="text/javascript" src="http://wp1.imithemes.com/autostars-wp/wp-content/themes/AutoStars/vendor/flexslider/js/jquery.flexslider.js?ver=0.1"></script>--}}
